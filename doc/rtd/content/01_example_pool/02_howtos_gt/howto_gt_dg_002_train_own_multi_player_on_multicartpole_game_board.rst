.. _Howto GT 002:
Howto GT-DG-002: Train Multi-Player with Own Policy on Gym Environment
======================================================================


**Executable code**

.. literalinclude:: ../../../../../test/howtos/rl/howto_gt_dg_002_train_own_multi_player_on_multicartpole_game_board.py
	:language: python
