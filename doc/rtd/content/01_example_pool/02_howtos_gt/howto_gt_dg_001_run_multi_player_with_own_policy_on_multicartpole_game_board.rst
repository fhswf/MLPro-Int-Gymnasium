.. _Howto GT 001:
Howto GT-DG-001: Run Multi-Player with Own Policy on Gym Environment
======================================================================


**Executable code**

.. literalinclude:: ../../../../../test/howtos/rl/howto_gt_dg_001_run_multi_player_with_own_policy_on_multicartpole_game_board.py
	:language: python
